...
import io.angularpay.banks.models.CreateBankCommandRequest;
import io.angularpay.banks.models.GenericCommandResponse;
import io.angularpay.banks.models.ResourceReferenceResponse;
...
@Service
@Profile("!test")
public class CreateBankCommand extends AbstractCommand<CreateBankCommandRequest, GenericCommandResponse>
        implements ResourceReferenceCommand<GenericCommandResponse, ResourceReferenceResponse>,
        BankUpdatePublisherCommand<GenericCommandResponse> {
    ...
    public CreateBankCommand(
        ...
        super("CreateBankCommand", mapper);
    ...
    @Override
    protected GenericCommandResponse handle(CreateBankCommandRequest request) {
        ...
        Bank response = this.mongoAdapter.createBank(bank);
    ...
    @Override
    protected List<ErrorObject> validate(CreateBankCommandRequest request) {
